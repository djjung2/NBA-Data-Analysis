...
#plot percentage of games that winning team had more of statistic (e.g. assists, personal fouls, etc.)
#     for each of the last ten seasons
#I analyze across 7 statistics (Points, Assists, Total rebounds, 3PT'ers made, Offensive rebounds, Turnovers, Personal fouls)
...
#winning game percentage dataframe including statistic of points
...
#time series plot over last 10 NBA seasons
#by season, find percentage of games that winning team had more of various statistics
time_plot <- ggplot(stats_by_year_percentage, aes(x=season_end_year, y=percent_winner_had_more, color=stat_name)) + 
  geom_line(size=1) +
  coord_cartesian(ylim = c(0,100)) + 
  labs(title = "NBA winning based on team statistics, 2009-2018",
       subtitle = "Percentage of games that winning team had more of various stats, by season.",
